	...
	<view>
		<headbar :title="'发起报修'"></headbar>
			<uni-forms ref="form" style="margin: 0 30rpx;padding-top: 30rpx;" label-position="top" label-align="left" label-width="auto" >
				...
				<uni-forms-item label="报修内容"  :errorMessage="err_obj&&err_obj['content']&&err_obj['content'][0]">
					<view class="bg-white border-radius-base " style="padding: 4px 15px;">
						...
						}" placeholder="请输入报修内容..." id="editor"></ber-editor> -->
					</view>
				</uni-forms-item>
		...
		<!-- <view class="na-main ">
			<view class="na-title-sm">报修主题</view>
			...
			<view class="na-title-sm p-t-30">报修内容</view>
...
<script>
	...
	export default {
		...
		methods: {
			...
			backFunc(){
				this.formData.kind = this.opts_all.is_illegal?.[2]?.key || 3
