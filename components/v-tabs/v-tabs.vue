<template>
  <view :id="elId" class="v-tabs">
    ...
    >
      ...
      >
        <view
          class="v-tabs__container-item" :class="current == i ? 'active' : ''"
          v-for="(v, i) in tabs"
          :key="i"
          :style="{
 ...
 * @property {String} activeColor = '#2979ff' 选中文字颜色,默认APP主题颜色
 ...
 * @property {String} lineColor = '#2979ff' 下划线的颜色 ,默认APP主题颜色
 * @property {Number} lineScale = 0.5 下划线的宽度缩放比例
 * @property {String} lineRadius = '10rpx' 下划线圆角
 * @property {Boolean} pills = [true | false] 是否胶囊样式
 * @property {String} pillsColor = '#2979ff' 胶囊背景色,默认APP主题颜色
...
.v-tabs {
  ...
  &__container {
    ...
    &-line {
		background:$uni-theme-secondary;
		border-radius:8rpx;
		position: absolute;
		bottom: 0;
    }
