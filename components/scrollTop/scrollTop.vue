<template>
	<view>
		<view class="fixedView icon" :animation="animationData" @tap="tapTop" @touchstart.stop="touchIcon" @touchmove.stop.prevent="moveIcon" @tap.stop="tapIcon" :style="{left:iconPosition.left+'px',top:iconPosition.top+'px',width:iconSize.width+'upx',height:iconSize.height+'upx'}">
...
<script>
	...
	export default {
		data() {
			return {
				animationData: {},
				icon_path:"../../../static/icon/mescroll-totop.png",
				windowSize:{
					width:0,
					height:0,
					margin:{
