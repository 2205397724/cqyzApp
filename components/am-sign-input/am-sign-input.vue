	...
	<view class="sign">
		<view class="imgBox">
			<view class="nom_img" v-if="!showImg">
				<image v-if="!showImg" src="/static/other/sign_icon.png" style="width:180px;height:60px;"
			...
			<view class="across_img" v-if="showImg">
				...
				<image v-if="showImg" :src="showImg" style="width:180px;height:60px;" @click="signModShow=true">
				</image>
			</view>
				...
				<view class="signBox" @tap.stop>
					<view class="wrapper">
						<view class="handBtn">
							...
							<button @click="signModShow=false" class="cancleBtn">取消</button>
						...
						setTimeout(() => {
							uni.canvasToTempFilePath({
								...
								success: function(res1) {
                                    ...
                                    that.$emit('signToUrl',res1.tempFilePath)
